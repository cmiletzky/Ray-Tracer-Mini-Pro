...
public class ReflectionRefractionTests {
	...
	public void proTests2() {
		...
		scene.geometries.add(
				...
				.setMaterial(new Material().setKs(0.8).setKd(0).setNShininess(60)).setEmmission(new Color(112,43,26)),
		...
		for (int i = 0; i < 1500; i+=40) {
			...
			.add(new Triangle(
					...
					.setEmmission(new Color(82,37,0)));
			...
			.add(
					...
					new Point3D(x-y, i, 7))
					.setMaterial(new Material().setKd(0).setKs(0.7).setNShininess(0).setKr(0))
					.setEmmission(new Color(0,70,0)));
		}
						

		for (int i = -300; i < 2500; i+=5) {

			scene.geometries.add(new Sphere(getRandomNumber(0.5,0.9), new Point3D(getRandomNumber(-0.5,1)*i, i, getRandomNumber(1.7,10))) //
					.setEmmission(new Color(getRandomNumber(0,200), getRandomNumber(0,200), getRandomNumber(0,200))) //
