...
public class GeometriesTest {
	    ...
	    public void findIntersections() {
	        ...
	        Sphere sphere = new Sphere(1,new Point3D(2,0,0));
	        ...
	        List<Point3D> result = geometries.findIntersectionsPoints(new Ray(new Point3D(0,4,0),new Vector(2.732115775904636,-4.492163336027315,0.470937088518219)));
	        ...
	        assertNull("Collection of shapes is empty",
	                geometries1.findIntersectionsPoints(new Ray(new Point3D(0,4,0),new Vector(2.732115775904636,-4.492163336027315,0.470937088518219))));
	        ...
	        result = geometries.findIntersectionsPoints(new Ray(new Point3D(0,4,0),new Vector(2.732115775904636,-4.492163336027315,0.470937088518219)));
	        assertEquals("Wrong number of points", 4, result.size());

	        // TC13: no shape is intersected with Ray
	        sphere = new Sphere(1,new Point3D(1,0,0));
	        ...
	        assertNull("no shape is intersected with Ray",
	                geometries.findIntersectionsPoints(new Ray(new Point3D(4,0,0),new Vector(1,0,0))));
	        // TC14: only 1 shape is intersected
	        List<Point3D> result2 = geometries.findIntersectionsPoints(new Ray(new Point3D(4,0,0),new Vector(-40,-1,-1)));
