...
public class SphereTests {
    ...
    public void testFindIntersections() {
        ...
        assertNull("there should not be intersection point",
        		sphere.findIntsersections(new Ray(new Point3D(1, 1.5, 0), new Vector(0, 1, 0))));
        ...
        result = sphere.findIntsersections(new Ray(new Point3D(1.25, 0.9682458365519, 0),
                                                               new Vector(0, -1, 0)));
       assertEquals("Wrong number of points", 1, result.size());
       assertEquals("Ray crosses sphere", List.of(p1), result);
       ...
       assertNull("there should not be intersection point",
    		   sphere.findIntsersections(new Ray(new Point3D(1.25, 0.9682458365519, 0),
                       new Vector(0, 1, 0))));
       ...
       p1 = new Point3D(1, 1, 0);
       result = sphere.findIntsersections(new Ray(new Point3D(1, -1, 0),
                                                              new Vector(0, 1, 0)));
      assertEquals("Wrong number of points", 1, result.size());
      assertEquals("Ray crosses sphere", List.of(p1), result);
      ...
      result = sphere.findIntsersections(new Ray(new Point3D(1, -0.5, 0),
                                                             new Vector(0, 1, 0)));
     assertEquals("Wrong number of points", 1, result.size());
     assertEquals("Ray crosses sphere", List.of(p1), result);
    ...
    assertNull("there should not be intersection point",
  		   sphere.findIntsersections(new Ray(new Point3D(1, 2, 0),
                     new Vector(0, 1, 0))));
    ...
    assertNull("there should not be intersection point",
   		   sphere.findIntsersections(new Ray(new Point3D(2, -1, 0),
                      new Vector(0, 1, 0))));
    
        // TC20: Ray starts at the tangent point
    
    assertNull("there should not be intersection point",
   		   sphere.findIntsersections(new Ray(new Point3D(2, 0, 0),
                      new Vector(0, 1, 0))));
